...
extern DM_MotorModule chassis_angle1;  // （左前）
extern DM_MotorModule chassis_angle2;  // （左后）
extern DM_MotorModule chassis_angle3;  // （右后）
extern DM_MotorModule chassis_angle4;  // （右前）
